<!--
   ...
   Modified: 2018-02-13 Dan: developed sample page with bootstrap
             ...
             2018-03-25 Dan:  changed to the array-based structure (so I can actually use it)
-->
<?php
$pagetitle = "Welcome";
      ...
      <section id="section1"><br><br><br><br>
       <form class="text-center" method="post" action="search.php">
         ...
         <div class="table-responsive">
            ...
            <td><input id="monAM" type="checkbox" name="times[0]" value="AM">Morning</td>
            <td><input id="monPM" type="checkbox" name="times[0]" value="PM">Afternoon</td>
             </tr>
             <tr>
            <th scope="row">Tuesday</th>
                 <td><input id="tueAM" type="checkbox" name="times[1]" value="AM">Morning</td>
                 <td><input id="tuePM" type="checkbox" name="times[1]" value="PM">Afternoon</td>
             </tr>
             <tr>
                 <th scope="row">Wednesday</th>
                 <td><input id="wedAM" type="checkbox" name="times[2]" value="AM">Morning</td>
                 <td><input id="wedPM" type="checkbox" name="times[2]" value="PM">Afternoon</td>
             </tr>
             <tr>
                 <th scope="row">Thursday</th>
                 <td><input id="thurAM" type="checkbox" name="times[3]" value="AM">Morning</td>
                 <td><input id="thurPM" type="checkbox" name="times[3]" value="PM">Afternoon</td>
             </tr>
             <tr>
                 <th scope="row">Friday</th>
                 <td><input id="friAM" type="checkbox" name="times[4]" value="AM">Morning</td>
                 <td><input id="friPM" type="checkbox" name="times[4]" value="PM">Afternoon</td>
             </tr>
             <tr>
                 <th scope="row">Satursday</th>
                 <td><input id="satAM" type="checkbox" name="times[5]" value="AM">Morning</td>
                 <td><input id="satPM" type="checkbox" name="times[5]" value="PM">Afternoon</td>
             </tr>
             <tr>
                 <th scope="row">Sunday</th>
                 <td><input id="sunAM" type="checkbox" name="times[6]" value="AM">Morning</td>
                 <td><input id="sunPM" type="checkbox" name="times[6]" value="PM">Afternoon</td>
             </tr>
             </tbody>
           </table>
